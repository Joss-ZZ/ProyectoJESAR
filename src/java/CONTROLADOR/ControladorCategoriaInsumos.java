 ...
 * @author Rodrigo
 */
public class ControladorCategoriaInsumos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("action").equalsIgnoreCase("Editar")) {
            ...
            CategoriaInsumo categoriaInsumo = new CategoriaInsumo(id, descripcion);
            categoriaInsumo.setConn(con);
            
            com.google.gson.JsonObject gson = new JsonObject();
            String datos = "";
            JsonArray array = new JsonArray();

            array = categoriaInsumo.MantenerCategoriaInsumo(categoriaInsumo, accion);
        ...
        if (request.getParameter("action").equalsIgnoreCase("Listar")) {
            ...
            String datos = "";
            JsonArray array = new JsonArray();
            array = categoriaInsumo.ListarCategoria(0, request.getParameter("action"));
            gson.add("datos", array);
            System.out.println(gson.toString());
        ...
        if (request.getParameter("action").equalsIgnoreCase("Eliminar")) {
            ...
            String accion = request.getParameter("action");
            int id = Integer.parseInt(request.getParameter("categoriaInsumos_id"));
            CategoriaInsumo categoriaInsumo = new CategoriaInsumo();
            categoriaInsumo.setConn(con);
            categoriaInsumo.setId(id);
            categoriaInsumo.MantenerCategoriaInsumo(categoriaInsumo, accion);
        }
    }
